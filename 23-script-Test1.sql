...
BEGIN
    ...
    INSERT INTO PHOTOMETRE (etat_photometre_PHOTOMETRE) VALUES ('occupÃ©');
...
BEGIN
    ...
    rollback;
    -- Si l'insertion réussit, affiche un message indiquant que le test a rate
...
EXCEPTION
    -- Si une erreur se produit, affiche un message indiquant que le test a echouÃe
    WHEN OTHERS THEN
        ROLLBACK;
